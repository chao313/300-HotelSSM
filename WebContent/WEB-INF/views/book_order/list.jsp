    ...
    <form id="add-form" method="post">
        <table>
            <tr>
                ...
                <td>
                    <select id="add-accountId" name="accountId" class="easyui-combobox" panelHeight="auto"
                            style="width:268px" data-options="required:true, missingMessage:'请选择客户'">
                        <c:forEach items="${accountList}" var="account">
                            <option value="${account.id }" real-name="${account.realName }" id-card="${account.idCard }"
                                    mobile="${account.mobile }">${account.name }</option>
                        </c:forEach>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" id="add-arriveDate" name="arriveDate"
                           class="wu-text easyui-datebox easyui-validatebox"/></td>
            </tr>
            <tr>
                <td align="right">离店日期:</td>
                <td><input type="text" id="add-leaveDate" name="leaveDate"
                           class="wu-text easyui-datebox easyui-validatebox"/></td>
            </tr>
            <tr>
    ...
    <form id="edit-form" method="post">
        ...
        <table>
            <tr>
                <td align="right">客户:</td>
                <td>
                    <select id="edit-accountId" name="accountId" class="easyui-combobox" panelHeight="auto"
                            style="width:268px" data-options="required:true, missingMessage:'请选择客户'">
                        <c:forEach items="${accountList}" var="account">
                            <option value="${account.id }" real-name="${account.realName }" id-card="${account.idCard }"
                                    mobile="${account.mobile }">${account.name }</option>
            ...
            <tr>
                <td align="right">入住日期:</td>
                <td><input type="text" id="edit-arriveDate" name="arriveDate"
                           class="wu-text easyui-datebox easyui-validatebox"/></td>
            </tr>
            <tr>
                <td align="right">离店日期:</td>
                <td><input type="text" id="edit-leaveDate" name="leaveDate"
                           class="wu-text easyui-datebox easyui-validatebox"/></td>
            </tr>
            <tr>
                <td align="right">状态:</td>
