    ...
    <form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td><input type="text" id="add-sn" name="sn" class="wu-text easyui-validatebox"
                           data-options="required:true, missingMessage:'请填写房间编号'"/></td>
            </tr>
            <tr>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'"
    ...
    <form id="edit-form" method="post">
        ...
        <table>
            ...
            <tr>
                <td align="right">房间编号:</td>
                <td><input type="text" id="edit-sn" name="sn" class="wu-text easyui-validatebox"
                           data-options="required:true, missingMessage:'请填写房间编号'"/></td>
            </tr>
            <tr>
                <td align="right">房间类型:</td>
